const level1 = new Level(
    ...
    [
        ...
        new Bottle('img/6.botella/2.Botella_enterrada1.png', 6100, 355),
        new Bottle('img/6.botella/2.Botella_enterrada1.png', 2620, 360),
        ...
        new Bottle('img/6.botella/1.Marcador.png', 5020, 355), 
        new Bottle('img/6.botella/2.Botella_enterrada2.png', 5830, 350),
        new Bottle('img/6.botella/2.Botella_enterrada2.png', 3830, 360),
        new Bottle('img/6.botella/2.Botella_enterrada1.png', 2330, 350), 
        new Bottle('img/6.botella/2.Botella_enterrada1.png', 2630, 360),
        ...
        new Bottle('img/6.botella/2.Botella_enterrada2.png', 5340, 360),
        new Bottle('img/6.botella/2.Botella_enterrada1.png', 1240, 360),
        new Bottle('img/6.botella/2.Botella_enterrada2.png', 5000, 350),
        new Bottle('img/6.botella/1.Marcador.png', 4920, 345), 
